...
}) => cn(buttonBaseClasses, buttonVariantClasses[variant], buttonSizeClasses[size]);
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(getButtonClasses({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100"),
