      ...
      <header className="border-b border-border bg-card sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-semibold text-foreground">Web 2.5 Voting System</h1>
        ...
        {!isElectionOpen ? (
          ...
          <div className="voting-card text-center py-12 animate-fade-in">
            ...
            <p className="text-muted-foreground mb-4">
              Your votes are secured with blockchain-backed auditing.
            </p>
              ...
              <div>
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Cast your vote for each position. Each vote is cryptographically secured with a blockchain audit layer.
                    </p>
            ...
            <div className="space-y-6">
              ...
              <div className="voting-card">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-semibold">Blockchain Audit Layer</h3>
                </div>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-success mt-0.5 flex-shrink-0" />
                    Each vote links to the previous block
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-success mt-0.5 flex-shrink-0" />
                    Tamper-evident audit trail for integrity checks
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-success mt-0.5 flex-shrink-0" />
                    Verify your vote anytime with a receipt
                  </li>
                </ul>
              </div>
            </div>
